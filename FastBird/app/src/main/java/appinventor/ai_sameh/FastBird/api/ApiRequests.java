...
public class ApiRequests {
    ...
    public static void getMyOrders(Context context, LoginRequest loginRequest, Response.Listener<ProgressOrderList> listener, Response.ErrorListener errorListener) {
        VolleyClient
                .getInstance(context)
                .getRequestQueue()
                .add(new GsonRequest<ProgressOrderList>(Request.Method.POST, API_BASE_URL + ME_PENDING_ORDERS, loginRequest, ProgressOrderList.class, null, listener, errorListener, VolleyClient.NO_RETRY_POLICY));
    }
    ...
    public static void getOrderHistory(Context context, LoginRequest loginRequest, Response.Listener<ProgressOrderList> listener, Response.ErrorListener errorListener) {
        VolleyClient
                .getInstance(context)
                .getRequestQueue()
                .add(new GsonRequest<ProgressOrderList>(Request.Method.POST, API_BASE_URL + ME_HISTORY_ORDERS, loginRequest, ProgressOrderList.class, null, listener, errorListener, VolleyClient.NO_RETRY_POLICY));
    }
    ...
    public static void getLocations(Context context, LoginRequest serviceTypeRequest, Response.Listener<LocationResponse> listener, Response.ErrorListener errorListener) {
        VolleyClient.getInstance(context).getRequestQueue()
                .add(new GsonRequest<LocationResponse>(Request.Method.POST, API_BASE_URL + LOCATIONS, serviceTypeRequest, LocationResponse.class, null, listener, errorListener, VolleyClient.NO_RETRY_POLICY));
    }
    ...
    public static void insertComment(Context context, InsertCommentRequest commentListRequest, Response.Listener<LoginResponse> listener, Response.ErrorListener errorListener) {
        VolleyClient.getInstance(context).getRequestQueue()
                .add(new GsonRequest<LoginResponse>(Request.Method.POST, API_BASE_URL + INSERT_COMMENT, commentListRequest, LoginResponse.class, null, listener, errorListener, VolleyClient.NO_RETRY_POLICY));
    }
    ...
    public static void changePassword(Context context, ChangePasswordRequest changePasswordRequest, Response.Listener<LoginResponse> listener, Response.ErrorListener errorListener) {
        VolleyClient
                .getInstance(context)
                .getRequestQueue()
                .add(new GsonRequest<LoginResponse>(Request.Method.POST, API_BASE_URL + CHANGE_PASSWORD, changePasswordRequest, LoginResponse.class, null, listener, errorListener, VolleyClient.NO_RETRY_POLICY));
    }
