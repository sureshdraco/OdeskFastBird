...
public class WithFastBirdOrdersFragment extends Fragment {
    ...
    public static final int ORDER_TYPE_SHIPMENTS = 1;
    public static final int ORDER_TYPE_PICKUPS = 2;
    ...
    private void getFastBirdOrders(String email, String password) {
        orderArrayAdapter = new OrderArrayAdapter(getActivity(), R.layout.orders_card_item, ORDER_TYPE_SHIPMENTS, false, false);
    ...
    private void getMyOrders(String email, String password) {
        orderArrayAdapter = new OrderArrayAdapter(getActivity(), R.layout.orders_card_item, ORDER_TYPE_PICKUPS, true, true, this);
        ordersListView.setAdapter(orderArrayAdapter);
    ...
    private void getHistoryOrders(String email, String password) {
        orderArrayAdapter = new OrderArrayAdapter(getActivity(), R.layout.orders_card_item, ORDER_TYPE_HISTORY, false, false);
        ordersListView.setAdapter(orderArrayAdapter);
