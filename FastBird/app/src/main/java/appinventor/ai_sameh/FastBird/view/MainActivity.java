...
public class MainActivity extends FragmentActivity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		mTabHost.addTab(mTabHost.newTabSpec("orders").setIndicator("", getResources().getDrawable(R.drawable.orders)),
		...
		mTabHost.addTab(mTabHost.newTabSpec("Notifications")
				.setIndicator("", getResources().getDrawable(R.drawable.notif)), NotificationFragment.class, b);
		b = new Bundle();
		b.putString("key", "+");
		mTabHost.addTab(mTabHost.newTabSpec("+")
				.setIndicator("", getResources().getDrawable(R.drawable.add_order)), CreateOrderFragment.class, b);
		b = new Bundle();
		b.putString("key", "$$");
		mTabHost.addTab(mTabHost.newTabSpec("$$").setIndicator("", getResources().getDrawable(R.drawable.money)),
				MoneyTabFragment.class, b);

		b = new Bundle();
		b.putString("key", "Profile");
		mTabHost.addTab(mTabHost.newTabSpec("Profile").setIndicator("", getResources().getDrawable(R.drawable.settings)),
