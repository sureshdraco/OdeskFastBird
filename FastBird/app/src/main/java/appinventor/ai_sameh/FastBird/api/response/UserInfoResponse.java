...
public class UserInfoResponse {
	...
	public class d {
		...
		private String BankAccountName, BankAccountNo, BankName, CPR, CRNo, ClientId, CompanyName, Country, CountryId, Credits, Email, FaxNo, FirstName, LastName, Mobile, Phone1,
				Phone2, DiscountPercent;
		private boolean VIP;
