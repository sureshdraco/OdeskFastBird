...
public class CreateOrderConfirmationActivity extends Activity {
    ...
    private void getServiceTypePrice() {
        ...
        ApiRequests.getServiceTypePrice(getApplicationContext(), new ServiceTypePriceRequest(user, password, createOrderRequest.getLocation(), createOrderRequest.getPickupaddress(), createOrderRequest.getWeight(), createOrderRequest.getLength(), createOrderRequest.getHeight(), createOrderRequest.getWidth(), createOrderRequest.getServicetype()), new Response.Listener<ServiceTypePriceResponse>() {
            @Override
