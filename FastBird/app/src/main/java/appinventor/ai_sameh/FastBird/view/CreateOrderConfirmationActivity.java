...
//        for (DataDescription dataDescription : PreferenceUtil.getLocations(getApplicationContext())) {
//            if (dataDescription.getDescription().equals(createOrderRequest.getLocation())) {
//                deliveryLocation = dataDescription.getId();
//            }
//        }
        ApiRequests.getServiceType(getApplicationContext(), new ServiceTypeRequest(PreferenceUtil.getEmail(getApplicationContext()), PreferenceUtil.getPassword(getApplicationContext()), deliveryLocation, pickupLocation), new Response.Listener<ServiceTypeResponse>() {
            @Override
    ...
    private void updateServiceTypes(ArrayList<DataDescription> serviceTypes) {
        PreferenceUtil.saveServiceTypes(getApplicationContext(), serviceTypes);
        ...
        ArrayAdapter<String> dataAdapter = new ArrayAdapter<String>
                (getApplicationContext(), android.R.layout.simple_spinner_item, serviceTypeList);
